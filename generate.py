...
if True:
    ...
    entity_model = AutoModelForMaskedLM.from_pretrained('joelniklaus/legal-xlm-roberta-large', return_dict=True).to(device)
    o_model = AutoModelForMaskedLM.from_pretrained('joelniklaus/legal-xlm-roberta-large', return_dict=True).to(device)
    tokenizer = AutoTokenizer.from_pretrained('joelniklaus/legal-xlm-roberta-large', do_lower_case=False)
