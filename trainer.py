...
if True:
    ...
    with torch.no_grad():
        ...
        model.bert.embeddings.word_embeddings.weight[-2, :] += model.bert.embeddings.word_embeddings.weight[4000, :].clone()
        model.bert.embeddings.word_embeddings.weight[-3, :] += model.bert.embeddings.word_embeddings.weight[4000, :].clone()
        model.bert.embeddings.word_embeddings.weight[-4, :] += model.bert.embeddings.word_embeddings.weight[177603, :].clone()
        model.bert.embeddings.word_embeddings.weight[-5, :] += model.bert.embeddings.word_embeddings.weight[177603, :].clone()
        model.bert.embeddings.word_embeddings.weight[-6, :] += model.bert.embeddings.word_embeddings.weight[15058, :].clone()
        model.bert.embeddings.word_embeddings.weight[-7, :] += model.bert.embeddings.word_embeddings.weight[15058, :].clone()
        model.bert.embeddings.word_embeddings.weight[-8, :] += model.bert.embeddings.word_embeddings.weight[2053, :].clone()
        model.bert.embeddings.word_embeddings.weight[-9, :] += model.bert.embeddings.word_embeddings.weight[2053, :].clone()
        model.bert.embeddings.word_embeddings.weight[-10, :] += model.bert.embeddings.word_embeddings.weight[9335, :].clone()
        model.bert.embeddings.word_embeddings.weight[-11, :] += model.bert.embeddings.word_embeddings.weight[9335, :].clone()
        model.bert.embeddings.word_embeddings.weight[-12, :] += model.bert.embeddings.word_embeddings.weight[96583, :].clone()
        model.bert.embeddings.word_embeddings.weight[-13, :] += model.bert.embeddings.word_embeddings.weight[96583, :].clone()
        model.bert.embeddings.word_embeddings.weight[-14, :] += model.bert.embeddings.word_embeddings.weight[29957, :].clone()
        model.bert.embeddings.word_embeddings.weight[-15, :] += model.bert.embeddings.word_embeddings.weight[29957, :].clone()
        # language markers
        model.bert.embeddings.word_embeddings.weight[-16, :] += model.bert.embeddings.word_embeddings.weight[144362, :].clone()
