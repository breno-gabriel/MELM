...
if True:
    ...
    with torch.no_grad():
        # label tokens
        model.bert.embeddings.word_embeddings.weight[-1, :] += model.bert.embeddings.word_embeddings.weight[1796, :].clone()
        model.bert.embeddings.word_embeddings.weight[-2, :] += model.bert.embeddings.word_embeddings.weight[1238, :].clone()
        model.bert.embeddings.word_embeddings.weight[-3, :] += model.bert.embeddings.word_embeddings.weight[1238, :].clone()
        model.bert.embeddings.word_embeddings.weight[-4, :] += model.bert.embeddings.word_embeddings.weight[20620, :].clone()
        model.bert.embeddings.word_embeddings.weight[-5, :] += model.bert.embeddings.word_embeddings.weight[20620, :].clone()
        model.bert.embeddings.word_embeddings.weight[-6, :] += model.bert.embeddings.word_embeddings.weight[2740, :].clone()
        model.bert.embeddings.word_embeddings.weight[-7, :] += model.bert.embeddings.word_embeddings.weight[2740, :].clone()
        model.bert.embeddings.word_embeddings.weight[-8, :] += model.bert.embeddings.word_embeddings.weight[2788, :].clone()
        model.bert.embeddings.word_embeddings.weight[-9, :] += model.bert.embeddings.word_embeddings.weight[2788, :].clone()
        model.bert.embeddings.word_embeddings.weight[-10, :] += model.bert.embeddings.word_embeddings.weight[2241, :].clone()
        model.bert.embeddings.word_embeddings.weight[-11, :] += model.bert.embeddings.word_embeddings.weight[2241, :].clone()
        model.bert.embeddings.word_embeddings.weight[-12, :] += model.bert.embeddings.word_embeddings.weight[2701, :].clone()
        model.bert.embeddings.word_embeddings.weight[-13, :] += model.bert.embeddings.word_embeddings.weight[2701, :].clone()
        model.bert.embeddings.word_embeddings.weight[-14, :] += model.bert.embeddings.word_embeddings.weight[2760, :].clone()
        model.bert.embeddings.word_embeddings.weight[-15, :] += model.bert.embeddings.word_embeddings.weight[2760, :].clone()
        # language markers
        model.bert.embeddings.word_embeddings.weight[-16, :] += model.bert.embeddings.word_embeddings.weight[8306, :].clone()
